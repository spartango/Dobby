...
public class DeleteRequestTest {
	...
	public void testInsertTransform() {
		...
		Request d1 = new DeleteRequest("Test", new StateVector(), 0, 14, 'e');
		Request d2 = new InsertRequest("Exam", new StateVector(), 1, 7, 'y');
		Request transform = d1.transform(d2);
		String product = transform.apply(d2.apply(testString));
		System.out.println(testString + " Delete-Ins -> " + product);
		assertTrue(product.equals("0123456y789abcdf"));
